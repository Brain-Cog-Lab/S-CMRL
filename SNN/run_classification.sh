...
CUDA_VISIBLE_DEVICES=7 python train_snn.py --model AVspikformer --dataset CREMAD --epoch 100 --batch-size 128 --num-classes 6 --step 4 --modality audio-visual --cross-attn --attn-method SpatialTemporal --alpha 3.0&
PID8=$!;
...
CUDA_VISIBLE_DEVICES=7 python train_snn.py --model AVspikformer --embed_dims 64 --dataset UrbanSound8K --epoch 100 --batch-size 128 --num-classes 10 --step 4 --modality audio-visual --cross-attn --attn-method SpatialTemporal --alpha 3.0 &
PID8=$!;
...
CUDA_VISIBLE_DEVICES=4 python train_snn.py --model AVspikformer --dataset CREMAD --epoch 100 --batch-size 128 --num-classes 6 --step 4 --modality audio-visual --cross-attn --attn-method SpatialTemporal --alpha 1.0 --contrastive&
PID5=$!;
...
CUDA_VISIBLE_DEVICES=0 python train_snn.py --model AVspikformer --embed_dims 64 --dataset UrbanSound8K --epoch 100 --batch-size 128 --num-classes 10 --step 4 --modality audio-visual --cross-attn --attn-method Spatial &
PID1=$!;

CUDA_VISIBLE_DEVICES=1 python train_snn.py --model AVspikformer --embed_dims 64 --dataset UrbanSound8K --epoch 100 --batch-size 128 --num-classes 10 --step 4 --modality audio-visual --cross-attn --attn-method Temporal &
PID2=$!;
...
CUDA_VISIBLE_DEVICES=0 python train_snn.py --model AVspikformer --dataset CREMAD --epoch 100 --batch-size 128 --num-classes 6 --step 4 --modality audio-visual --cross-attn --attn-method SpatialTemporal --alpha 1.0 --contrastive --temperature 1.0 --snr 0 --output ./exp_results_snr --tensorboard-dir ./exp_results_snr&
PID1=$!;

CUDA_VISIBLE_DEVICES=1 python train_snn.py --model AVspikformer --dataset CREMAD --epoch 100 --batch-size 128 --num-classes 6 --step 4 --modality audio-visual --cross-attn --attn-method SpatialTemporal --alpha 1.0 --contrastive --temperature 1.0 --snr 5 --output ./exp_results_snr --tensorboard-dir ./exp_results_snr&
PID2=$!;

CUDA_VISIBLE_DEVICES=2 python train_snn.py --model AVspikformer --dataset CREMAD --epoch 100 --batch-size 128 --num-classes 6 --step 4 --modality audio-visual --cross-attn --attn-method SpatialTemporal --alpha 1.0 --contrastive --temperature 1.0 --snr 10 --output ./exp_results_snr --tensorboard-dir ./exp_results_snr&
PID3=$!;

CUDA_VISIBLE_DEVICES=3 python train_snn.py --model AVspikformer --dataset CREMAD --epoch 100 --batch-size 128 --num-classes 6 --step 4 --modality audio-visual --cross-attn --attn-method SpatialTemporal --alpha 1.0 --contrastive --temperature 1.0 --snr 15 --output ./exp_results_snr --tensorboard-dir ./exp_results_snr&
PID4=$!;

CUDA_VISIBLE_DEVICES=4 python train_snn.py --model AVspikformer --dataset CREMAD --epoch 100 --batch-size 128 --num-classes 6 --step 4 --modality audio-visual --cross-attn --attn-method SpatialTemporal --alpha 1.0 --contrastive --temperature 1.0 --snr 20 --output ./exp_results_snr --tensorboard-dir ./exp_results_snr&
PID5=$!;

CUDA_VISIBLE_DEVICES=5 python train_snn.py --model AVspikformer --dataset CREMAD --epoch 100 --batch-size 128 --num-classes 6 --step 4 --modality audio-visual --cross-attn --attn-method SpatialTemporal --alpha 1.0 --contrastive --temperature 1.0 --snr 25 --output ./exp_results_snr --tensorboard-dir ./exp_results_snr&
PID6=$!;

CUDA_VISIBLE_DEVICES=6 python train_snn.py --model AVspikformer --dataset CREMAD --epoch 100 --batch-size 128 --num-classes 6 --step 4 --modality audio-visual --cross-attn --attn-method SpatialTemporal --alpha 1.0 --contrastive --temperature 1.0 --snr 30 --output ./exp_results_snr --tensorboard-dir ./exp_results_snr&
PID7=$!;

CUDA_VISIBLE_DEVICES=7 python train_snn.py --model AVspikformer --dataset CREMAD --epoch 100 --batch-size 128 --num-classes 6 --step 4 --modality audio-visual --cross-attn --attn-method SpatialTemporal --alpha 1.0 --contrastive --temperature 1.0 --output ./exp_results_snr --tensorboard-dir ./exp_results_snr&
PID8=$!;
...
#CUDA_VISIBLE_DEVICES=0 python train_snn.py --model AVspikformer --dataset AVmnistdvs --epoch 100 --batch-size 128 --num-classes 10 --step 64 --modality audio-visual --shallow-sps --embed_dims 32 --event-size 28 --cross-attn --attn-method SpatialTemporal --alpha 1.0 --contrastive &
#
#CUDA_VISIBLE_DEVICES=1 python train_snn.py --model AVspikformer --dataset AVmnistdvs --epoch 100 --batch-size 128 --num-classes 10 --step 64 --modality audio-visual --shallow-sps --embed_dims 64 --event-size 28 --cross-attn --attn-method SpatialTemporal --alpha 1.0 --contrastive &
#
#CUDA_VISIBLE_DEVICES=2 python train_snn.py --model AVspikformer --dataset AVmnistdvs --epoch 100 --batch-size 128 --num-classes 10 --step 64 --modality audio-visual --shallow-sps --embed_dims 128 --event-size 28 --cross-attn --attn-method SpatialTemporal --alpha 1.0 --contrastive &
#
#CUDA_VISIBLE_DEVICES=3 python train_snn.py --model AVspikformer --dataset AVmnistdvs --epoch 100 --batch-size 128 --num-classes 10 --step 64 --modality audio-visual --shallow-sps --embed_dims 256 --event-size 28 --cross-attn --attn-method SpatialTemporal --alpha 1.0 --contrastive &
#
#CUDA_VISIBLE_DEVICES=4 python train_snn.py --model AVspikformer --dataset AVmnistdvs --epoch 100 --batch-size 128 --num-classes 10 --step 64 --modality audio-visual --shallow-sps --embed_dims 512 --event-size 28 --cross-attn --attn-method SpatialTemporal --alpha 1.0 --contrastive &

# --------F. 超参数实验---------------
CUDA_VISIBLE_DEVICES=0 python train_snn.py --model AVspikformer --embed_dims 64 --dataset UrbanSound8K --epoch 100 --batch-size 128 --num-classes 10 --step 4 --modality audio-visual --cross-attn --attn-method SpatialTemporal --alpha 1.5 --contrastive --temperature 0.01 &
PID1=$!;

CUDA_VISIBLE_DEVICES=1 python train_snn.py --model AVspikformer --embed_dims 64 --dataset UrbanSound8K --epoch 100 --batch-size 128 --num-classes 10 --step 4 --modality audio-visual --cross-attn --attn-method SpatialTemporal --alpha 1.5 --contrastive --temperature 0.07 &
PID2=$!;

CUDA_VISIBLE_DEVICES=2 python train_snn.py --model AVspikformer --embed_dims 64 --dataset UrbanSound8K --epoch 100 --batch-size 128 --num-classes 10 --step 4 --modality audio-visual --cross-attn --attn-method SpatialTemporal --alpha 1.5 --contrastive --temperature 0.5 &
PID3=$!;

CUDA_VISIBLE_DEVICES=3 python train_snn.py --model AVspikformer --embed_dims 64 --dataset UrbanSound8K --epoch 100 --batch-size 128 --num-classes 10 --step 4 --modality audio-visual --cross-attn --attn-method SpatialTemporal --alpha 1.5 --contrastive --temperature 1.0 &
PID4=$!;

CUDA_VISIBLE_DEVICES=4 python train_snn.py --model AVspikformer --dataset CREMAD --epoch 100 --batch-size 128 --num-classes 6 --step 4 --modality audio-visual --cross-attn --attn-method SpatialTemporal --alpha 1.0 --contrastive --temperature 0.01 &
PID5=$!;

CUDA_VISIBLE_DEVICES=5 python train_snn.py --model AVspikformer --dataset CREMAD --epoch 100 --batch-size 128 --num-classes 6 --step 4 --modality audio-visual --cross-attn --attn-method SpatialTemporal --alpha 1.0 --contrastive --temperature 0.07 &
PID6=$!;

CUDA_VISIBLE_DEVICES=6 python train_snn.py --model AVspikformer --dataset CREMAD --epoch 100 --batch-size 128 --num-classes 6 --step 4 --modality audio-visual --cross-attn --attn-method SpatialTemporal --alpha 1.0 --contrastive --temperature 0.5 &
PID7=$!;

CUDA_VISIBLE_DEVICES=7 python train_snn.py --model AVspikformer --dataset CREMAD --epoch 100 --batch-size 128 --num-classes 6 --step 4 --modality audio-visual --cross-attn --attn-method SpatialTemporal --alpha 1.0 --contrastive --temperature 1.0 &
PID8=$!;
