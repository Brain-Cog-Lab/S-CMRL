...
CUDA_VISIBLE_DEVICES=0 python train_snn_cl.py --model AVspikformer --embed_dims 64 --dataset UrbanSound8K --epoch 100 --batch-size 128 --num-classes 10 --step 4 --modality audio-visual --class_num_per_step 10 --cross-attn --attn-method SpatialTemporal --alpha 0.0 --contrastive&
PID1=$!;

CUDA_VISIBLE_DEVICES=1 python train_snn_cl.py --model AVspikformer --embed_dims 64 --dataset UrbanSound8K --epoch 100 --batch-size 128 --num-classes 10 --step 4 --modality audio-visual --class_num_per_step 10 --cross-attn --attn-method SpatialTemporal --alpha 0.3 --contrastive&
PID2=$!;

CUDA_VISIBLE_DEVICES=2 python train_snn_cl.py --model AVspikformer --embed_dims 64 --dataset UrbanSound8K --epoch 100 --batch-size 128 --num-classes 10 --step 4 --modality audio-visual --class_num_per_step 10 --cross-attn --attn-method SpatialTemporal --alpha 0.5 --contrastive&
PID3=$!;

CUDA_VISIBLE_DEVICES=3 python train_snn_cl.py --model AVspikformer --embed_dims 64 --dataset UrbanSound8K --epoch 100 --batch-size 128 --num-classes 10 --step 4 --modality audio-visual --class_num_per_step 10 --cross-attn --attn-method SpatialTemporal --alpha 0.6 --contrastive&
PID4=$!;

CUDA_VISIBLE_DEVICES=4 python train_snn_cl.py --model AVspikformer --embed_dims 64 --dataset UrbanSound8K --epoch 100 --batch-size 128 --num-classes 10 --step 4 --modality audio-visual --class_num_per_step 10 --cross-attn --attn-method SpatialTemporal --alpha 0.8 --contrastive&
PID5=$!;

CUDA_VISIBLE_DEVICES=5 python train_snn_cl.py --model AVspikformer --embed_dims 64 --dataset UrbanSound8K --epoch 100 --batch-size 128 --num-classes 10 --step 4 --modality audio-visual --class_num_per_step 10 --cross-attn --attn-method SpatialTemporal --alpha 1.0 --contrastive&
PID6=$!;

CUDA_VISIBLE_DEVICES=6 python train_snn_cl.py --model AVspikformer --embed_dims 64 --dataset UrbanSound8K --epoch 100 --batch-size 128 --num-classes 10 --step 4 --modality audio-visual --class_num_per_step 10 --cross-attn --attn-method SpatialTemporal --alpha 1.5 --contrastive&
PID7=$!;

CUDA_VISIBLE_DEVICES=7 python train_snn_cl.py --model AVspikformer --embed_dims 64 --dataset UrbanSound8K --epoch 100 --batch-size 128 --num-classes 10 --step 4 --modality audio-visual --class_num_per_step 10 --cross-attn --attn-method SpatialTemporal --alpha 2.0 --contrastive&
PID8=$!;
